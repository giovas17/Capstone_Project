 ...
 */
public class GhostRecipeHelpScreen3 extends Fragment {
    private TextView helpText;
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        Typeface typeface = Typeface.createFromAsset(getActivity().getAssets(),getString(R.string.font_path));
        View view = inflater.inflate(R.layout.fragment_ghost_recipehelpscreen3, container, false);
   ...
   public static GhostRecipeHelpScreen3 newInstance(){
        return new GhostRecipeHelpScreen3();
    }
}
